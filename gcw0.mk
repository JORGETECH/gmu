...
DECODERS_TO_BUILD  = \
		     ...
		     decoders/speex.so \
		     decoders/wavpack.so \
#		     decoders/musepack.so

FRONTENDS_TO_BUILD = \
                     frontends/sdl.so \
                     frontends/gmuhttp.so \

GCW0_SDK          ?= /opt/RG350_buildroot/output/host/
...
CFLAGS             = \
                     ...
                     -I$(GCW0_SDK)/usr/mipsel-gcw0-linux-uclibc/sysroot/usr/include/ \
...
DEC_opus_CFLAGS=-I$(GCW0_SDK)/usr/mipsel-gcw0-linux-uclibc/sysroot/usr/include/opus
